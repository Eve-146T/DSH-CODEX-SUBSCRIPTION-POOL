...
export function imageToolDefinition(ctx) {
    return defineTool({
        name: 'image_gen',
        description: 'Generate an image with OpenAI through the signed-in ChatGPT/Codex subscription. Use this when the user asks to create, draw, render, or generate an image.',
        parameters: {
            prompt: {
                type: 'string',
                required: true,
