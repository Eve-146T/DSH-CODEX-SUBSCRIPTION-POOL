window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = `
      ...
      .codexAccounts{border-top:1px solid var(--dsw-alias-border-l2)}.codexAccountGroup{border-bottom:1px solid var(--dsw-alias-border-l2)}.codexAccount{display:grid;grid-template-columns:34px max-content minmax(170px,1fr);align-items:center;column-gap:12px;row-gap:12px;padding:8px 0}
      ...
      .codexMeter{display:flex;grid-column:3;min-width:0;margin-left:12px;align-self:stretch;flex-direction:column;justify-content:space-between;padding:1px 0 7px}.codexMeterCopy{display:flex;align-items:center;justify-content:flex-end;gap:18px}.codexMeterValue{font-size:13px;font-weight:600;white-space:nowrap}.codexMeterReset{color:var(--dsw-alias-label-tertiary);font-size:11px;white-space:nowrap}.codexMeterTrack{height:7px;overflow:hidden;border-radius:99px;background:var(--dsw-alias-bg-skeleton)}.codexMeterFill{height:100%;min-width:3px;border-radius:inherit}.codexMeterFill.good{background:var(--dsw-alias-state-success-primary)}.codexMeterFill.warn{background:#f0a12b}.codexMeterFill.low{background:var(--dsw-alias-state-error-primary)}.codexMeterEmpty{grid-column:3;margin-left:12px;color:var(--dsw-alias-label-tertiary);font-size:12px}.codexAccountActions{display:grid;grid-column:2/4;grid-template-columns:118px 138px 98px;justify-content:end;gap:8px;min-width:0}.codexResetSlot{display:flex;width:118px;height:38px;align-items:center;justify-content:flex-end}.codexAccountAction{height:38px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;line-height:20px!important;white-space:nowrap!important}.codexActivate{width:138px!important;padding:0 10px!important}.codexActivate:disabled{opacity:.55}.codexDisconnect{box-sizing:border-box!important;width:98px!important;border:1px solid var(--dsw-alias-state-error-primary)!important;border-radius:19px!important;color:var(--dsw-alias-state-error-primary)!important;background:transparent!important;padding:0 12px!important}.codexDisconnect:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)!important}.codexRedeem{width:118px!important;padding:0 10px!important;border-color:var(--dsw-alias-state-business-primary)!important;color:var(--dsw-alias-state-business-primary)!important}
