window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = `
      ...
      .codexAccounts{border-top:1px solid var(--dsw-alias-border-l2)}.codexAccountGroup{border-bottom:1px solid var(--dsw-alias-border-l2)}.codexAccount{display:grid;grid-template-columns:34px max-content minmax(170px,1fr);align-items:center;column-gap:12px;row-gap:5px;padding:10px 0}
